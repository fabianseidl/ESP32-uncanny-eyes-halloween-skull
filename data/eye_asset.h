// Pick exactly ONE #include below. Rebuild and reflash to change style.
// See README "Eye gallery (compile-time)".
#pragma once

// #include "data/default_large.h"

// Classic 128^2-baked assets (NN-stretched to 466^2 by the row expander):
